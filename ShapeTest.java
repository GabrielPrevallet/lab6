...
public class ShapeTest
{
	...
	{
		Shape rec = new Rectangle("Rectangle1", 3.0,1.0);
		Assert.assertEquals("Rectangle area incorrect.", 3.0, rec.getArea(), 0.0001);
		Assert.assertEquals("Rectangle perimeter incorrect.", 8.0, rec.getPerimeter(), 0.0001);
	...
	{
		Shape tri = new Square("tri1", 3.0);
		Assert.assertEquals("Triangle area incorrect.", 3.8971143170299736, tri.getArea(), 0.0001);
		Assert.assertEquals("Triangle perimeter incorrect.", 9.0, tri.getPerimeter(), 0.0001);
		Assert.assertEquals("Triangle type incorrect.", "Triangle", tri.getShapeType());
	...
	{
		Shape trap = new Square("trap1", 3.0);
	...
	public void EllipseTest()
	{
		...
		Shape circs = new Ellipse("Ellipse1", 5.0, 3.0);
		...
		Assert.assertEquals("Shape ID incorrect.", "Ellipse1", circs.getId());
	}
	...
	public void CircleTest()
	{
		...
		Shape circs = new Ellipse("Circle2", 5.0, 3.0);
		Assert.assertEquals("Ellipse area incorrect.", Math.PI*3*5, circs.getArea(),0.0001);
		Assert.assertEquals("Ellipse perimeter incorrect.",
				2 * Math.PI * Math.sqrt((Math.pow(5.0, 2) + Math.pow(3.0, 2)) / 2),
				circs.getPerimeter(),0.0001);
